...
ax.annotate(r'$\mathrm{\lambda}$-transition',xy=(he.T_lambda+0.05,0.3),rotation=90)
ax.annotate(r'$\rho_s / \rho$',xy=(1,0.85),c='b')
ax.annotate(r'$\rho_n / \rho$',xy=(1,0.08),c='r')
ax.set_xlabel('Temperature (K)')
ax.set_ylabel('Fraction')

polish(fig, 0.6, name= r'C:\Users\KFNT\Github\Posters_2025\Images\component_fraction', extension='.png', grid=False, tight_layout=True, transparent=True)        
