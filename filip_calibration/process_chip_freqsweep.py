...
for temp in temps[:]:
    ...
    freqsweep_all = rf'D:\OneDrive_copy\OneDrive - Univerzita Karlova\DATA\2023-03-Helmholtz_resonators\Helmholtz_res_drive_dep\{temp}\fsweeps\resonator_{height:}{letter:}\*.npy'
    ...
    for num, file in enumerate(Ffiles[0:10]):
        #print(num)
    ...
    for file in Freqfiles: 
        ...
        if save:
            path_save = fr'D:\OneDrive_copy\OneDrive - Univerzita Karlova\DATA\2023_4_Helmholtz_resonators_recal_2\Helmholtz_fsweeps\{folder.split("_")[0]}\{height:}{letter:}'
