...
ampsweeps = rf'..\..\2023-03-Helmholtz_resonators\Helmholtz_res_drive_dep/{Temp:}/ampsweeps_fast/resonator_{resonator}_updowndown/*.npy'
...
for num, file in enumerate(Ffiles[10:20]):
    ...
    amp = d['App (V)']
    for frequency in f:
        correct_drives.append(bridgelosses(letter, frequency, amp).get_loss())
